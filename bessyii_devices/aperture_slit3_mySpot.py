...
class SlitsSpot(Device):
    s3t = Cpt(EpicsMotor, 'l0204000')
    s3b = Cpt(EpicsMotor, 'l0204001')
    s3l = Cpt(EpicsMotor, 'l0204002')
    s3r = Cpt(EpicsMotor, 'l0204003')
...
class SlitmySpot(PseudoPositioner):
